...
def train_model(model, optimizer, loss_fn, train_loader, val_loader, epochs, scheduler, early_stopper):
...
train_model(model, Optimizer, loss_fn, train_loader, val_loader, epochs, scheduler)
